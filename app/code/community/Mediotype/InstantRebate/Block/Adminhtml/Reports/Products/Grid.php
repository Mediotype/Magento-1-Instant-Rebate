<?php
class Mediotype_InstantRebate_Block_Adminhtml_Reports_Products_Grid extends Mage_Adminhtml_Block_Widget_Grid
{

    public function _prepareLayout()
    {
        $this->addExportType('*/*/productsSoldByRebateCsv', Mage::helper('customer')->__('CSV'));
